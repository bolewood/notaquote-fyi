...
test("pinned: the California state-minimum line", () => {
  assert.equal(
    ...
    "State minimum: $30,000 per person and $60,000 per crash for injuries you cause, plus $15,000 for property damage. Your policy includes uninsured and underinsured motorist coverage unless you turn it down in writing. This doesn't include comprehensive or collision, which pay to fix your own car.",
  )
