...
- `/corrections` ("Help make this better") links to GitHub issue forms in `.github/ISSUE_TEMPLATE/`: a number looks wrong, a state rule is missing or wrong, a vehicle is missing or classified wrong, and something's broken. The visitor reviews and submits the issue on GitHub. Nothing is sent from this site.
